...
namespace Runtime
{
    ...
    /// </summary>
    public abstract class ObservableScriptableObject : ScriptableObject, IManagedObject, INotifyPropertyChanged
    {
        ...
        {
            PropertyChanged?.Invoke(this, e ?? throw new ArgumentNullException(nameof(e)));
        }
        ...
        {
            if (comparer?.Equals(field, newValue) ?? throw new ArgumentNullException(nameof(comparer)))
            {
                return false;
            }
        ...
        /// </remarks>
        protected bool SetPropertyAndNotifyOnCompletion(
            [NotNull] ref TaskNotifier? taskNotifier,
            Task? newValue,
            [CallerMemberName] string? propertyName = null
        )
        {
        ...
        /// <exception cref="System.ArgumentNullException">Thrown if <paramref name="callback"/> is <see langword="null"/>.</exception>
        protected bool SetPropertyAndNotifyOnCompletion(
            [System.Diagnostics.CodeAnalysis.NotNull] ref TaskNotifier? taskNotifier,
            Task? newValue,
        ...
        )
        {
            ...
            return SetPropertyAndNotifyOnCompletion(
        ...
        /// </remarks>
        protected bool SetPropertyAndNotifyOnCompletion<T>(
            [System.Diagnostics.CodeAnalysis.NotNull] ref TaskNotifier<T>? taskNotifier,
            Task<T>? newValue,
            [CallerMemberName] string? propertyName = null
        )
        {
            return SetPropertyAndNotifyOnCompletion(
                taskNotifier ??= new TaskNotifier<T>(),
                newValue,
                null,
                propertyName
            );
        ...
        /// <param name="propertyName">(optional) The name of the property that changed.</param>
        /// <returns><see langword="true"/> if the property was changed, <see langword="false"/> otherwise.</returns>
        private bool SetPropertyAndNotifyOnCompletion<TTask>(
            ITaskNotifier<TTask> taskNotifier,
            TTask? newValue,
            ...
            where TTask : Task
        {
            ...
            async void MonitorTask()
            {
                ...
                await new TaskAwaitableWithoutEndValidation(newValue!);
