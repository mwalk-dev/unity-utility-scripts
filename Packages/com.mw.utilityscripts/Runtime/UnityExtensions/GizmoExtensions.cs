// From https://github.com/code-beans/GizmoExtensions
// MIT licensed
...
namespace Runtime
{
    public static class GizmosExtensions
    {
        ...
        )
        {
            ...
            {
                var to =
                    new Vector3(radius * Mathf.Sin(i * Mathf.Deg2Rad), 0, radius * Mathf.Cos(i * Mathf.Deg2Rad))
                    + deltaTranslation;
                Gizmos.DrawLine(from, to);
                from = to;
            }
        ...
        public static void DrawWireCapsule(Vector3 center, float radius, float height, Quaternion rotation = default)
        {
            ...
            var mat =
                Matrix4x4.Translate(center + rotation * Vector3.up * half)
            ...
            //draw lower cap
            mat =
                Matrix4x4.Translate(center + rotation * Vector3.down * half)
                * Matrix4x4.Rotate(
                    rotation * Quaternion.AngleAxis(90, Vector3.up) * Quaternion.AngleAxis(-90, Vector3.forward)
                );
            DrawWireArc(mat, radius, 180, 20);
